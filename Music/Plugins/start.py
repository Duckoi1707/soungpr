...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton(text="sᴜᴘᴘᴏʀᴛ​", url=f"https://t.me/xU_S_A1"),
            InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/URLS_USA"),
        ],
        [
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton(text="✨ sᴜᴘᴘᴏʀᴛ​", url="https://t.me/xU_S_A1"),
            InlineKeyboardButton("✨ ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/URLS_USA"),
        ],
        [
            InlineKeyboardButton("📚 ᴄᴏᴍᴍᴀɴᴅ ​📚", url="https://telegra.ph/ᴛsɪᴅᴛᴏɴɪ-ᴇx-𝑥-𝐕ᵏʸ𝐌ᵒᵒⁿ-12-20"),
        ],
