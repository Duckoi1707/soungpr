...
async def load_start():
    ...
    if restart_data:
        print("[INFO]: SENDING RESTART STATUS TO CATY SERVER")
        try:
    ...
    for served_chat in served_chats:
        try:
            ...
            print("Error came while clearing db")
            pass     
    await app.send_message(LOG_GROUP_ID, "Caty Music Bot Started")
    await client.send_message(LOG_GROUP_ID, "Assistant Of Caty Music Started")
    print("[INFO]: STARTED THE CATY BOT AND SENDING THE INFO TO CATY SERVER")
